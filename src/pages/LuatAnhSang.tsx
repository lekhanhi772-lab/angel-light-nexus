  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-16">
        ...
        {/* Guest Agreement Step */}
        {!user && showGuestAgreement && !showAuthForm && (
          <div 
            className="rounded-2xl p-8 text-center"
            style={{
              background: 'linear-gradient(135deg, rgba(255, 251, 230, 0.95) 0%, rgba(240, 255, 244, 0.95) 100%)',
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4 mb-8">
              <Checkbox
                ...
                className="w-7 h-7 border-3 border-[#FFD700] data-[state=checked]:bg-[#FFD700] data-[state=checked]:border-[#FFD700]"
              />
              <label 
                htmlFor="guest-agree" 
            ...
            <Button
              ...
              className="text-xl px-10 py-7 rounded-full font-semibold transition-all duration-300 disabled:opacity-50"
              style={{
                ...
                boxShadow: guestAgreed 
                  ? '0 0 40px rgba(255, 215, 0, 0.7), 0 0 80px rgba(255, 215, 0, 0.4)' 
                  : 'none',
              }}
            >
        ...
        {!user && showAuthForm && (
          ...
          >
            <div className="flex justify-between items-center mb-6">
              ...
              >
                ✨ {authMode === 'signup' ? 'Đăng ký tài khoản' : 'Đăng nhập'}
              </h3>
              <button
                onClick={() => {
              ...
              >
                <X className="w-6 h-6" style={{ color: '#8B7355' }} />
              </button>
            </div>
            ...
            <Button
              ...
              disabled={loading}
              className="w-full mb-4 py-6 text-lg rounded-xl transition-all duration-300 hover:scale-[1.02]"
              style={{
                background: 'white',
                color: '#5C4033',
                border: '2px solid rgba(255, 215, 0, 0.5)',
            ...
            <div className="flex items-center gap-4 my-6">
              ...
              <span style={{ color: '#8B7355' }}>hoặc</span>
              <div className="flex-1 h-px bg-yellow-300"></div>
            </div>
            ...
            <div className="space-y-4">
              <input
                ...
                className="w-full px-4 py-4 rounded-xl text-lg outline-none transition-all duration-300 focus:ring-2"
                style={{
                  background: 'white',
                  border: '2px solid rgba(255, 215, 0, 0.3)',
                  color: '#5C4033',
              ...
              <Button
                ...
                className="w-full py-6 text-lg rounded-xl font-semibold transition-all duration-300 disabled:opacity-50"
                style={{
                  background: 'linear-gradient(135deg, #FFD700 0%, #FFA500 100%)',
                  color: '#1a1a1a',
